...
var FileStorage_1 = __importDefault(require("./internal/common/FileStorage"));
var NodeFetchStreamTransport_1 = __importDefault(require("./internal/net/NodeFetchStreamTransport"));
...
var DEFAULT_STITCH_DIR = ".stitch/apps";
var appClients = {};
var Stitch = (function () {
    function Stitch() {
    }
    ...
    Stitch.initializeAppClient = function (clientAppId, config) {
        ...
        if (builder.dataDirectory === undefined || builder.dataDirectory === "") {
            var dataPath = path_1.join(os_1.homedir(), DEFAULT_STITCH_DIR, clientAppId);
            fs_extra_1.ensureDirSync(dataPath);
            builder.withDataDirectory(dataPath);
        }
        if (builder.storage === undefined) {
            builder.withStorage(new FileStorage_1.default(builder.dataDirectory));
        }
        if (builder.transport === undefined) {
            builder.withTransport(new NodeFetchStreamTransport_1.default());
        }
